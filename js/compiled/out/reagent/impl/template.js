...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__24384__auto__,writer__24385__auto__,opt__24386__auto__){
return cljs.core._write.call(null,writer__24385__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__23786__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__23786__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__23786__auto__)){
return or__23786__auto__;
} else {
...
var G__38756 = o;
(G__38756[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__38757__delegate = function (args){
...
while (G__38758__i < G__38758__a.length) {G__38758__a[G__38758__i] = arguments[G__38758__i + 0]; ++G__38758__i;}
  args = new cljs.core.IndexedSeq(G__38758__a,0);
} 
return G__38757__delegate.call(this,args);};
G__38757.cljs$lang$maxFixedArity = 0;
G__38757.cljs$lang$applyTo = (function (arglist__38759){
var args = cljs.core.seq(arglist__38759);
return G__38757__delegate(args);
});
...
var old_38760 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_38760))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_38760)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__23774__auto__ = (node === document.activeElement);
if(and__23774__auto__){
var and__23774__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__23774__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__38763 = jsprops;
(G__38763["defaultValue"] = value);

(G__38763["onChange"] = ((function (G__38763,v,value,on_change){
return (function (p1__38761_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38761_SHARP_);
});})(G__38763,v,value,on_change))
);
...
var vec__38765 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38765,(0),null);
var id = cljs.core.nth.call(null,vec__38765,(1),null);
var class$ = cljs.core.nth.call(null,vec__38765,(2),null);
...
var temp__4427__auto__ = (function (){var G__38769 = cljs.core.meta.call(null,v);
var G__38769__$1 = (((G__38769 == null))?null:reagent.impl.template.get_key.call(null,G__38769));
return G__38769__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__38771_38772 = v;
var G__38771_38773__$1 = (((G__38771_38772 == null))?null:reagent.impl.template.key_from_vec.call(null,G__38771_38772));
var G__38771_38774__$2 = (((G__38771_38773__$1 == null))?null:(jsprops["key"] = G__38771_38773__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__38777 = cljs.core.meta.call(null,argv);
var G__38777__$1 = (((G__38777 == null))?null:reagent.impl.template.get_key.call(null,G__38777));
return G__38777__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__38778 = (((jsprops == null))?{}:jsprops);
(G__38778["key"] = key);
...
var G__38779 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38779;
continue;
}
} else {
...
var n__24689__auto___38780 = a.length;
var i_38781 = (0);
while(true){
if((i_38781 < n__24689__auto___38780)){
(a[i_38781] = reagent.impl.template.as_element.call(null,(a[i_38781])));
...
var a = cljs.core.into_array.call(null,s);
var n__24689__auto___38783 = a.length;
var i_38784 = (0);
while(true){
if((i_38784 < n__24689__auto___38783)){
var val_38785 = (a[i_38784]);
if((cljs.core.vector_QMARK_.call(null,val_38785)) && ((reagent.impl.template.key_from_vec.call(null,val_38785) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38784] = reagent.impl.template.as_element.call(null,val_38785));

var G__38786 = (i_38784 + (1));
i_38784 = G__38786;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__23774__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__23774__auto__){
return (ctx["no-key"]);
} else {
return and__23774__auto__;
...
var G__38788 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38788) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38788){
...
//# sourceMappingURL=template.js.map?rel=1453744768016